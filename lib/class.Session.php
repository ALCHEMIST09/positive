<?php
	...
	class Session
	{
		 ...
		 * @param int $duration Duration of the cookie
		 */
		public function setCookieVar($name, $value, $duration)
		{
			setcookie($pass, $value, time() + $duration);
		}
		...
		/**
		 * Convert a string representation of an object
		 * back to an instance of the object
		 * @param string $object_string
		 */
		public function unSerializeObject($object_string)
		{
			$object_instance = unserialize($object_string);
